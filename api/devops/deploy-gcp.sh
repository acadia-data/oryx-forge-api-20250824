cd api
gcloud run deploy oryx-forge-dev-20250823 --source . --region us-central1 --allow-unauthenticated  --set-env-vars GOOGLE_CLOUD_PROJECT=adt-dev-414714 --project=adt-dev-414714
