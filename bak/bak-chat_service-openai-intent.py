...
class TargetReference(BaseModel):
    ...
    dataset: str = Field(description="Dataset name_python - use exact value from available datasets")
    sheet: str = Field(description="Sheet name (for new sheets: generate a descriptive name like an Excel tab, 2-4 words capturing the analysis purpose. For existing sheets: use exact name_python)")
    is_new: bool = Field(description="Whether this is a new sheet to be created (true) or existing sheet to edit (false)")
